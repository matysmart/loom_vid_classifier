...
def main():
    # Load the Excel file
    file_path = 'linksTestResultsGroundTruth4.xlsx'  # Replace with your Excel file path
    ...
    for row in sheet.iter_rows(min_row=2):  # Assuming headers are in the first row
        ...
        download_loom_video_to_file(url_str=video_url, trimmed_filename="single_video.avi")
